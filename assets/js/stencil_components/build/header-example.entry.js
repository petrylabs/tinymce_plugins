...
const HeaderExample = class {
    ...
    render() {
        const langJsonEn = `{"search":"Search","login":"Log In","gaq":"Get a Quote","back":"Back","skipToMainContent":"Skip to main content","getAQuoteUrl":"http:\\\\localhost:3333\\getAQuote.html"}`;
...
export { HeaderExample as header_example };
