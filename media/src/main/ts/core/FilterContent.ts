...
const setup = function (editor) {
  editor.on('preInit', function () {
    ...
    tinymce.util.Tools.each('video audio iframe object'.split(' '), function (name) {
    ...
    tinymce.util.Tools.each('webkitallowfullscreen mozallowfullscreen allowfullscreen'.split(' '), function (name) {
      boolAttrs[name] = {};
    });
