...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    concat: {
      license: {
        ...
        files: {
          'dist/accordion/plugin.js': [
            'src/text/license-header.js',
            scratchPluginMinPath
          ],
          'dist/accordion/plugin.min.js': [
            'src/text/license-header.js',
            scratchPluginMinPath
          ]
        }
    ...
    copy: {
      css: {
        files: [
          ...
          { src: ['changelog.txt'], dest: 'dist/accordion', expand: true }
        ]
      }
    },
  ...
  grunt.registerTask('version', 'Creates a version file', function () {
    grunt.file.write('dist/accordion/version.txt', BUILD_VERSION);
  });
